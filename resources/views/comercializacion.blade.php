...
<div class="container mt-4 texto">
    <div class="container mt-5">
        ...
        <section class="mb-5">
            <div class="row align-items-center">
                ...
                <div class="col-md-6">
                    <img src="imagenes/envios.jpg" class="img-fluid rounded shadow" alt="">
                </div>
        ...
        <div class="col-md-6 col-lg-4">
            <div class="card h-100 text-center shadow-sm">
                <div class="card-body">
                    ...
                    <p class="text-muted">
                        Podés solicitar cambios dentro de los 7 días posteriores
                        a la compra.
                    </p>
                    <p class="fw-bold">
...
<div class="text-center mt-5 mb-4">
    ...
    <p class="text-muted">Todo lo que necesitás saber antes de comprar</p>
</div>
  ...
  <div class="accordion-item">
    ...
    <div id="faq1" class="accordion-collapse collapse">
      <div class="accordion-body">
         Los envíos pueden demorar entre 24 hs y 4 días hábiles según tu ubicación.
      </div>
    </div>
  </div>
</div>
